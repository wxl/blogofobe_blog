...
######################################################################
# This is your site's blogofobe configuration file.
# http://github.com/wxl/blogofobe
#
# This file doesn't list every possible setting, it relies on defaults
# set in the core blogofobe _config.py. To see where the default
# configuration is on your system run 'blogofobe info'
#
######################################################################
...
#  (You don't _have_ to use blogofobe to build blogs)
blog.enabled = True
...
blog.name = "My Blogofobe Example"
